...
public class ChangeBookingFrame extends JFrame {
    ...
    public ChangeBookingFrame(Connection connection, ManageRecord manageRecord, ExecuteTransaction transaction, GenerateReport report) {
        ...
        // let user choose to either refund or reschedule a booking

        // let user choose a booking id 

        // if the booking status is 'paid', 'pending',
